...
class HtmlFirDump internal constructor(private var linkResolver: FirLinkResolver, private val session: FirSession) {
    ...
    private fun FlowContent.generate(assignmentOperatorStatement: FirAssignmentOperatorStatement) {
        generateBinary(
            assignmentOperatorStatement.leftArgument, assignmentOperatorStatement.rightArgument, assignmentOperatorStatement.operation
        )
    }
    ...
    private fun FlowContent.generate(expression: FirExpression) {
        exprType(expression.typeRef) {
            when (expression) {
                ...
                is FirAssignmentOperatorStatement -> generate(expression)
